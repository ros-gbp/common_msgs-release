## common_msgs (noetic) - 1.13.2-1

The packages in the `common_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic common_msgs` on `Fri, 25 Apr 2025 23:37:18 -0000`
...
## common_msgs (melodic) - 1.12.8-1

The packages in the `common_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic common_msgs` on `Tue, 12 Jan 2021 13:12:03 -0000`
...
## common_msgs (noetic) - 1.13.1-1

The packages in the `common_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic common_msgs` on `Mon, 11 Jan 2021 22:10:07 -0000`
...
## common_msgs (noetic) - 1.13.0-1

The packages in the `common_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic common_msgs` on `Thu, 21 May 2020 18:39:36 -0000`
...
## common_msgs (noetic) - 1.12.7-1

The packages in the `common_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic common_msgs` on `Sun, 23 Feb 2020 22:12:12 -0000`
...
## common_msgs (melodic) - 1.12.7-0

The packages in the `common_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic common_msgs` on `Wed, 07 Nov 2018 07:20:37 -0000`
...
## common_msgs (lunar) - 1.12.7-0

The packages in the `common_msgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -t lunar -r lunar common_msgs` on `Wed, 07 Nov 2018 07:07:23 -0000`
